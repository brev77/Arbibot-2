...
- **Last major update (2026-04-30):** DEX-1.0 фундамент — 10 шагов → `done` (ADR-STRUCTURE, TECH-CHOICE, ABIS/`@arbibot/contracts-eth`, RPC/RpcProviderManager, MIGRATIONS/`033_dex_on_chain.sql`, VAULT/KeyVaultService, WALLET-MGT/WalletManagerService, GAS/GasEstimatorService, FILTERS, ENV-EXAMPLE); 3 DEX блокера исправлены; Build 21/21 green; `FE-SETTINGS-POLICY-WORKSPACE` → `implemented` (awaiting `/review-step`); Phase 5 OpenClaw formal steps → `done`; Phase 4 closed (2026-04-21)
