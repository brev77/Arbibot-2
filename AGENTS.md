...
**Quality Metrics (на коммите `df2177a`, 2026-07-16):** Build 22/22 ✅ | Lint 29/29 ✅ (0 errors) | Tests 778/778 ✅ (74 suites) | Migrations 001–047 (после PAD — 046 paper_trades settlement, 047 paper.auto_drive seed)
...
- `npm run db:migrate` — apply SQL migrations under `infra/postgres/migrations/` (001–047)
