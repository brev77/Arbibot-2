...
- **Last major update (2026-05-18):** DEX план — **35/35 → `done`** (DEX-1 полностью завершён); стабилизация DEX сервисов (коммит `48f3548`) — pool-discovery tests 94 строки, RPC worker leak fix, все pre-existing test issues ИСПРАВЛЕНЫ (285/285 tests pass); Build 21/21 ✅, Lint 28/28 ✅; **следующие шаги: DEX Frontend UI, DEX-2 multi-chain**
...
- CI зелёный на GitHub Actions не верифицирован (локально lint 28/28 ✅, build 21/21 ✅, tests 285/285 ✅)
