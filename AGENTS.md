...
- **Last major update (2026-05-06):** DEX план — **21/35 шагов → `done`**; DEX-1.2 — FILL-TRACKING (DexFillTrackerService, LegFilledPayloadV2, migration 034), RECON-ONCHAIN (3 DEX detectors, 7/7 tests), OUTBOX-EVENTS (DexOutboxEventsService, 3 event types, Kafka bridge allowlist, 10/10 tests) → done; Lint 28/28 ✅, Build 21/21 ✅; **следующий шаг: `DEX-1-2-MEMPOOL`**
