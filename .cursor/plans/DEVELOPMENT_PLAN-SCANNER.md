...
**Прогресс:** 16/24 (Phase 0 ✅, Phase 1 ✅, S2-1/S2-2 ✅) | **Обновлено:** 2026-07-24 | **Детали шагов:** интегрированы в индекс ниже (план компактный, без подпапок шагов).

> **Статус плана:** Phase 0 + Phase 1 + S2-1/S2-2 завершены. Next: S2-3-DEDUP → S2-4-INTEGRATE.
