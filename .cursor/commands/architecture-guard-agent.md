---
description: Architecture Guard Agent — проверка инвариантов и границ Arbibot 2
---
...
- **первичный запуск:** paper — обязательный операционный E2E прогон до live с минимальным капиталом (`DEVELOPMENT_PLAN.md`, раздел «Операционная последовательность первичного запуска»); live не зависит от paper и наоборот, но paper — полноценный этап приёмки
...
Контекст для проверки (изменения, ADR, контракты, PR):
