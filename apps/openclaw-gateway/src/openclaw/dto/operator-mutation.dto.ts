...
/** Required context for approve-gated OpenClaw mutations (audit + idempotency). */
export class OpenclawOperatorMutationDto {
...
export class ResolveIncidentMutationDto extends OpenclawOperatorMutationDto {}
