...
/** Maps a supported chain id to the env-var network token (ARBITRUM/BASE/BNB). */
...
export class ScannerRpcService implements OnModuleInit, OnModuleDestroy {
  ...
  /** Chains the scanner scans by default (Arb/Base/BNB mainnet). Driven by config poolWhitelist. */
