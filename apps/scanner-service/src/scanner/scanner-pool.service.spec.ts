...
describe('ScannerPoolService', () => {
  ...
  describe('diagnostics accessors', () => {
    ...
    it('resolveFactoryMapping returns mappings for Ethereum mainnet DEXes', () => {
      // Uniswap V2 on Ethereum mainnet.
      expect(service.resolveFactoryMapping(1, '0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f')).toBeDefined();
      // Uniswap V3 on Ethereum mainnet.
      expect(service.resolveFactoryMapping(1, '0x1F98431c8aD98523631AE4a59f267346ea31F984')).toBeDefined();
      // SushiSwap V2 on Ethereum mainnet.
