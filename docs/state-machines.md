...
> `infra/postgres/migrations/001–057` (055–057 — probe-миграции, добавлены 2026-08-13/14
> и не входили в верификацию 08-11). CHECK-констрейнты в БД — источник истины
